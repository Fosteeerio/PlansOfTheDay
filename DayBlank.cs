...
namespace DesktopCalendar
{
    public partial class DayBlank : UserControl
    {
        ...
        public void Refresh(Color backColor, int day, DateTime date, Color foreColor)
        {
            ...
            _appointments = FosterSQL.GetAppointments(date);
        ...
        {
            new List<Control> { dayNumber , ActiveAppointmentsLabel,ActiveAppointmentPanel,
        ...
        private void DayBlank_Click(object sender, EventArgs e)
        {
            BackColor = _backColor;
            new NewAppointmentForm(_currentDate, null).ShowDialog();
        }
